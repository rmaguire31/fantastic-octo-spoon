...
for i = 1:length(captures)
    ...
    [
        ...
        captures{i}.stats.roll_peak_dist,...
    ] = analyse(...
        captures{i}.t,...
        captures{i}.roll,...
        captures{i}.f,...
    ...
    [
        ...
        captures{i}.stats.pitch_peak_dist,...
    ] = analyse(...
        captures{i}.t,...
        captures{i}.pitch,...
        captures{i}.f,...
    ...
    for i = 1:length(captures)
        ...
        roll_stats.String = sprintf(...
            [...
                ...
                'Roll Variance: %10g\n'...
                'Peak Roll: %10g\n'...
                'Peak Roll Frequency: %10g\n'...
            ],...
            captures{i}.stats.roll_mean,...
            captures{i}.stats.roll_var,...
            captures{i}.stats.roll_peak,...
            captures{i}.stats.roll_f_peak...
        );
        roll_stats.Units = 'normalized';
        roll_stats.Position = [0.1, 0.1, 0.4, 1];
        ...
        pitch_stats.String = sprintf(...
            [...
                ...
                'Pitch Variance: %10g\n'...
                'Peak Pitch: %10g\n'...
                'Peak Pitch Frequency: %10g'
            ],...
            captures{i}.stats.pitch_mean,...
            captures{i}.stats.pitch_var,...
            captures{i}.stats.pitch_peak,...
            captures{i}.stats.pitch_f_peak...
        );
        pitch_stats.Units = 'normalized';
        pitch_stats.Position = [0.5, 0.1, 0.4, 1];
