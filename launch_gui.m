...
if ~exist(mbed_loc, 'dir')
    uiwait(errordlg(...
        [...
            'Unable to find MBED filesystem. Try specifying the path '...
            'to the filesystem as an argument.'...
        ],...
...
if ~exist(cache_loc, 'dir')
    uiwait(errordlg(...
        [...
            'Unable to create cache directory. Try creating '...
            'directory ''' cache_loc ''' manually.'...
        ],...
        'Permission Denied'...
    ));
...
reload_btn.Callback =...
    @(h,data)helpdlg(...
        sprintf([...
            ...
            'reconnecting the MBED to flush its filesystem.'...
        ]),...
        'To Reload Capture'...
    );
